...
public static Datapoint betriebsart = new Datapoint(WolfDevice.HEIZUNG, 2, "Betriebsart", "DPT_HVACContrMode", false, "");
...
public static Datapoint bm2_Außentemperatur = new Datapoint(WolfDevice.BM_2,54 ,"Außentemperatur", "DPT_Value_Temp", false, "°C");
public static Datapoint bm2_Raumtemperatur = new Datapoint(WolfDevice.BM_2,55, "Raumtemperatur", "DPT_Value_Temp", false,"°C");
public static Datapoint bm2_Warmwasserssolltemperatur = new Datapoint(WolfDevice.BM_2, 56, "Warmwassersolltemperatur", "DPT_Value_Temp",  true,  "°C");
/*
...
public static Datapoint cwl_ZeitweiseIntensivlüftungAnAus = new Datapoint(WolfDevice.CWL, 153, "Zeitweise Intensivlüftung AN/AUS","DPT_Switch",true,"");
public static Datapoint cwl_ZeitweiseIntensivlüftungStartdatum = new Datapoint(WolfDevice.CWL, 154 , "Zeitweise Intensivlüftung Startdatum","DPT_Date",true,""); 
public static Datapoint cwl_ZeitweiseIntensivlüftungEnddatum = new Datapoint(WolfDevice.CWL, 155 , "Zeitweise Intensivlüftung Enddatum","DPT_Date",true,"");
public static Datapoint cwl_ZeitweiseIntensivlüftungStartzeit = new Datapoint(WolfDevice.CWL, 156 , "Zeitweise Intensivlüftung Startzeit","DPT_TimeOfDay",true,"");
public static Datapoint cwl_ZeitweiseIntensivlüftungEndzeit = new Datapoint(WolfDevice.CWL, 157 , "Zeitweise Intensivlüftung Endzeit","DPT_TimeOfDay",true,"");
public static Datapoint cwl_ZeitweiserFeuchteschutzAnAus = new Datapoint(WolfDevice.CWL, 158 , "Zeitweiser Feuchteschutz AN/AUS","DPT_Switch",true,"");
public static Datapoint cwl_ZeitweiserFeuchteschutzStartdatum = new Datapoint(WolfDevice.CWL, 159 , "Zeitweiser Feuchteschutz Startdatum","DPT_Date",true,"");
public static Datapoint cwl_ZeitweiserFeuchteschutzEnddatum = new Datapoint(WolfDevice.CWL, 160 , "Zeitweiser Feuchteschutz Enddatum","DPT_Date",true,"");
public static Datapoint cwl_ZeitweiserFeuchteschutzStartzeit = new Datapoint(WolfDevice.CWL, 161 , "Zeitweiser Feuchteschutz Startzeit","DPT_TimeOfDay",true,"");
public static Datapoint cwl_ZeitweiserFeuchteschutzEndzeit = new Datapoint(WolfDevice.CWL, 162 , "Zeitweiser Feuchteschutz Endzeit","DPT_TimeOfDay",true,"");
public static Datapoint cwl_Lueftungsstufe = new Datapoint(WolfDevice.CWL, 163 , "Lüftungsstufe","DPT_Scaling",false,"%");
public static Datapoint cwl_Ablufttemperatur = new Datapoint(WolfDevice.CWL, 164 , "Ablufttemperatur","DPT_Value_Temp",false,"°C");
public static Datapoint cwl_Frischlufttemperatur = new Datapoint(WolfDevice.CWL, 165 , "Frischlufttemperatur","DPT_Value_Temp",false,"°C");
public static Datapoint cwl_LuftdurchsatzZuluft = new Datapoint(WolfDevice.CWL, 166 , "Luftdurchsatz Zuluft","DPT_FlowRate_m3/h",false,"m³/h");
public static Datapoint cwl_LuftdurchsatzAbluft = new Datapoint(WolfDevice.CWL, 167 , "Luftdurchsatz Abluft","DPT_FlowRate_m3/h",false," m³/h");
public static Datapoint cwl_ByPassInitialisierung = new Datapoint(WolfDevice.CWL, 168 , "Bypass Initialisierung","DPT_Bool",false,"");
public static Datapoint cwl_ByPassOffen = new Datapoint(WolfDevice.CWL, 169 , "Bypass öffnet/offen","DPT_Bool",false,"");
public static Datapoint cwl_ByPassGeschlossen = new Datapoint(WolfDevice.CWL, 170 , "Bypass schließt/geschlossen","DPT_Bool",false,"");
public static Datapoint cwl_ByPassFehler = new Datapoint(WolfDevice.CWL, 171 , "Bypass Fehler","DPT_Bool",false,"");
public static Datapoint cwl_FrostStatusInitialisierungWarte = new Datapoint(WolfDevice.CWL, 172 , "Frost Status: Initialisierung/Warte","DPT_Bool",false,"");
public static Datapoint cwl_FrostStatusKeinFrost = new Datapoint(WolfDevice.CWL, 173 , "Frost Status: Kein Frost","DPT_Bool",false,"");
public static Datapoint cwl_FrostStatusVorwaermer = new Datapoint(WolfDevice.CWL, 174 , "Frost Status: Vorwärmer","DPT_Bool",false,"");
public static Datapoint cwl_FrostStatusFehlerUnausgeglichen = new Datapoint(WolfDevice.CWL, 175 , "Frost Status: Fehler/Unausgeglichen","DPT_Bool",false,"");
